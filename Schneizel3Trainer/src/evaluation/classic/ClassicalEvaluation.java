...
//            }
            ...
            while(allyPieceBitboard!=0){
                ...
                eval += pieceValue;
                eval += PST[board.side][pieceIndex][squareIndex];
...
//                }
            ...
            while(enemyPieceBitboard!=0){
                ...
                eval -= pieceValue;
                eval -= PST[board.opponent][pieceIndex][squareIndex];
...
//                }
        ...
        eval += Math.abs(31.5-opponentKingSquare) * kingPositionalScoreMultiplier;
        eval -= Math.abs(31.5-board.kingSquare) * kingPositionalScoreMultiplier;
...
//        eval -= KING_END_GAME_PST[board.opponent][opponentKingSquare] * endGameWeight;
    ...
    public static float evaluatePawns(int side, long allyPawns, long enemyPawns, float endGameWeight){
        ...
        while(pawns != 0){
            ...
            eval += PAWN_VALUE;
            eval += PST[side][PAWN_INDEX][squareIndex];
