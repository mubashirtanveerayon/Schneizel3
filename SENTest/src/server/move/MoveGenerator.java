...
public class MoveGenerator {
    ...
    public static void addMovesToList(long moveMask, int startSquare, int pieceIndex,  Board board, ArrayList<Move> list){
        while(moveMask != 0){
            ...
            list.add(new Move(startSquare,targetSquare,pieceIndex,board.indicesBoard[targetSquare],INVALID_INDEX));
    ...
    public static void generateWhitePawnCaptures(Board board, ArrayList<Move> list){
        ...
        while(captureRightNoPromotions != 0){
            ...
            if((targetSquareMask & board.pinRays[startSquare]) != 0){
                int targetSquare = Long.numberOfTrailingZeros(targetSquareMask);
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,board.indicesBoard[targetSquare],INVALID_INDEX));
            }
        ...
        while(captureRightPromotionMoves!=0){
            ...
            if((targetSquareMask & board.pinRays[startSquare]) != 0){
                int targetSquare = Long.numberOfTrailingZeros(targetSquareMask);
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,board.indicesBoard[targetSquare],QUEEN_INDEX));
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,board.indicesBoard[targetSquare],KNIGHT_INDEX));
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,board.indicesBoard[targetSquare],ROOK_INDEX));
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,board.indicesBoard[targetSquare],BISHOP_INDEX));
            }
        }
...
//                    }
                ...
                if(epPossible){
                    ...
                    long targetSquareMask = PAWN_ATTACKS[board.side][startSquare] & board.checkRayMask & board.epMask & board.pinRays[startSquare];
                    if (targetSquareMask!=0) {
                        int targetSquare = Long.numberOfTrailingZeros(targetSquareMask);
                        list.add(new Move(startSquare,targetSquare,PAWN_INDEX,INVALID_INDEX,INVALID_INDEX));
                    }
                }
...
//                    }
    ...
    public static void generateWhitePawnMoves(Board board, ArrayList<Move> list){
        ...
        while(singlePushPromotions != 0){
            ...
            if((targetSquareMask & board.pinRays[startSquare]) != 0){
                int targetSquare = Long.numberOfTrailingZeros(targetSquareMask);
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,INVALID_INDEX,QUEEN_INDEX));
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,INVALID_INDEX,KNIGHT_INDEX));
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,INVALID_INDEX,ROOK_INDEX));
                list.add(new Move(startSquare,targetSquare,PAWN_INDEX,INVALID_INDEX,BISHOP_INDEX));
            }
        }
    ...
    public static void generateQueenCaptures(int square,Board board, ArrayList<Move> list){
        if((SQUARE_MASKS[square] & board.pinnedPiecesMask) != 0){
            ...
            list.add(new Move(square,targetSquare,QUEEN_INDEX,board.indicesBoard[targetSquare],INVALID_INDEX));
    ...
    public static void generateBishopCaptures(int square, Board board, ArrayList<Move> list){
        if((SQUARE_MASKS[square] & board.pinnedPiecesMask) != 0){
            ...
            if(bishopCapture != 0){
                ...
                list.add(new Move(square,targetSquare,BISHOP_INDEX,board.indicesBoard[targetSquare], INVALID_INDEX));
            }
        }else if(board.isDoubleCheck){
    ...
    public static void generateRookCaptures(int square, Board board, ArrayList<Move> list){
        if((SQUARE_MASKS[square] & board.pinnedPiecesMask) != 0){
            ...
            if(rookCapture != 0){
                ...
                list.add(new Move(square,targetSquare,ROOK_INDEX,board.indicesBoard[targetSquare], INVALID_INDEX));
            }
        }else if(board.isDoubleCheck){
    ...
    public static void generateKingMoves( Board board, ArrayList<Move> list){
        ...
        if ((board.castle & CASTLE_BIT_MASK[board.side][QUEEN_SIDE_CASTLE_INDEX]) != 0){
            if((KING_CASTLING_PATH[board.side][QUEEN_SIDE_CASTLE_INDEX] & (~board.safeSquares | board.occupied)) == 0 && (SQUARE_MASKS[board.kingSquare-3] & board.occupied) == 0){
                list.add(new Move(board.kingSquare,board.kingSquare-2,KING_INDEX,INVALID_INDEX,INVALID_INDEX));
            }
        }
