...
public class PGNUtils {
    ...
    public static Move parse(String san, Board board,ArrayList<Move> allMoves){//san to move
        ...
        if (san.equalsIgnoreCase(QUEEN_SIDE_CASTLING)){
            ...
            if(board.whiteToMove){
                return new Move(board.side,WHITE_KING_INITIAL_POSITION,WHITE_KING_INITIAL_POSITION-2,KING_INDEX,INVALID_INDEX,INVALID_INDEX);
            }else{
                return new Move(board.side,BLACK_KING_INITIAL_POSITION,BLACK_KING_INITIAL_POSITION-2,KING_INDEX,INVALID_INDEX,INVALID_INDEX);
            }
